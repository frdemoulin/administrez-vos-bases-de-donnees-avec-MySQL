...
--
-- Client :  localhost
-- Généré le :  Sam 02 Mars 2019 à 19:21
...
--
ALTER TABLE `Animal`
  MODIFY `id` smallint(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--
...
-- Ajout d'un prix dans les tables race et espece
